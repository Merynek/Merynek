    ...
    render() {
        ...
        return (
            <div className="prcinka">
                ...
                {this._renderLine(Img25, "Naše první jízda na lodi", {}, Img26, "Naše první procházka v jeskyni", {})}
                {this._renderLine(Img27, "Naše první svatba :D", {objectPosition: "0px 0px"}, Img28, "Náš první vyhlídkový let vedle letadla", {})}
                ...
                {this._renderLine(Img38, "Naše jedna z mnoha vrcholku hor", {}, Img39, "Náš první Halloween", {objectPosition: "0px 0px"})}
                <div>
                    <span>Zdá se že prvních věcí mame za sebou hodně, ale vím že spolu zažijeme hromady a hromady dalších prvních vecí a že to nejkrásnější  nás teprve čeká.</span>
                    <span>Konec</span>
                    <span>Menší sexy foto koutek</span>
